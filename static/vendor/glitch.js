...
(function ($) {
  ...
  var _glitch = function (canvas, amount) {
    ...
    // over all the pixels in the image twice. It maybe possible to optimize
    // this by combining both loops into one, and only processing every other
    // line, as alternate lines are replaced with black in the 'scan lines'
    // block below
